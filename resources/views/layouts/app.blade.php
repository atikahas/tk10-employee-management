...
<head>
    ...
    <link href="{{url('')}}/softui/assets/css/soft-ui-dashboard.css?v=1.0.4" rel="stylesheet">
...
<body class="g-sidenav-show  bg-gray-100 ">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3" id="sidenav-main">
        <div class="sidenav-header">
            ...
            <img src="{{url('')}}/softui/img/logo/logo.png" class="navbar-brand-img h-100" alt="main_logo">
            <span class="ms-3 font-weight-bold">AGA Office</span>
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse w-auto h-auto" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                <li class="nav-item">
                    ...
                    <div class="collapse " id="dashboardsExamples">
                        <ul class="nav ms-4 ps-3">
                            <li class="nav-item ">
                                <a class="nav-link " href="https://soft-ui-dashboard-pro-laravel.creative-tim.com/dashboard-default">
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#laravelExamples" class="nav-link " aria-controls="applicationsExamples" role="button" aria-expanded="true">
                    ...
                    <div class="collapse show" id="laravelExamples">
                        <ul class="nav ms-4 ps-3">
                            <li class="nav-item ">
                                <a class="nav-link @yield('a-users')" href="{{ route('users.index') }}">
                                    <span class="sidenav-mini-icon"> MU </span>
                                    <span class="sidenav-normal"> Manage User </span>
                                </a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link @yield('a-roles')" href="{{ route('roles.index') }}">
                                    <span class="sidenav-mini-icon"> MR </span>
                                    <span class="sidenav-normal"> Manage Role </span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="row align-items-center justify-content-lg-between">
                    <div class="col-lg-6 mb-lg-0 mb-4">
                        <div class="copyright text-center text-sm text-muted text-lg-start">
                            AGA Group <script>document.write(new Date().getFullYear())</script> ©
                        </div>
                    </div>
                    <div class="col-lg-6">
                    </div>
